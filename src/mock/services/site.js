...
const templateList = [
  {
    id: Random.increment(), name: '空白', group: '常用', img: Random.dataImage('200x120'),
    data: [
      {
  ...
  {
    id: Random.increment(), name: '首页', group: '推荐', img: Random.dataImage('200x120'),
    data: [
      {
        "id": "a2cbbcccb4a0456ebd5779ec7f69cda5",
        "x": 0,
  ...
  {
    id: Random.increment(), name: '详情', group: '推荐', img: Random.dataImage('200x120'),
    data: []
  },
  {
    id: Random.increment(), name: '报表', group: '推荐', img: Random.dataImage('200x120'),
    data: []
  },
  {
    id: Random.increment(), name: '门户网站', group: '北京', img: Random.dataImage('200x120'),
    data: [
      {
        "id": "a2cbbcccb4a0456ebd5779ec7f69cda5",
        "x": 0,
  ...
  {
    id: Random.increment(), name: '新闻详情', group: '北京', img: Random.dataImage('200x120'),
    data: []
  }
]
